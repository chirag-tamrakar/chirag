...
class markSheet:
    ...
    def markk(self):
        if self.operator=="":
            ...
            self.englishP=self.english/100*100
            self.englishG=(self.englishP/20)-1
            
            self.computerP=self.computer/100*100
            self.computerG=(self.computerP/20)-1
...
print("Nepali ******************************* 100 ************************",mark.nepali,"***************************",mark.nepaliG)
print("Computer ***************************** 100 ************************",mark.computer,"***************************",mark.computerG)
print("English ****************************** 100 ************************",mark.english,"***************************",mark.englishG)
print
